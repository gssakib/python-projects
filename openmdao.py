...
class MultiplyByTwoComponent(Component):
	def __init__(self):
		...
		## class MultiplyByTwoComponent has function add_param that takes 'x_input' and 'val' as parameters
		self.add_param('x_input',val = 0.) # the input that will be multiplied by 2.
		
		## class MultiplyByTwoComponent has function add_output that takes 'y_input' and 'shape' as parameters
